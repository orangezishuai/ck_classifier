...
def main():
    ...
    pre_path = ""
    torch.load('./mbv3/pretrained/mobilenetv3-large-657e7b3d.pth', map_location=device)
    # torch.load('./mbv3/pretrained/mobilenetv3-small-c7eb32fe.pth', map_location=device)
